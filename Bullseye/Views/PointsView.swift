...
//  Bullseye
//
//  Created by Oscar Cristaldo on 2020-12-27.
//
...
struct PointsView: View {
    ...
    var body: some View {
        VStack(spacing: 10) {
            ...
            TargetTextView(text: String(roundedValue))
...
struct PointsView_Previews: PreviewProvider {
    ...
    static var previews: some View {
        PointsView(alertIsVisible: alertVisible, sliderValue: sliderValue, game: game)
        PointsView(alertIsVisible: alertVisible, sliderValue: sliderValue, game: game)
